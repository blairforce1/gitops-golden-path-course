...
- **A dev-container or toolbox image.** Solves the workstation, not CI, unless CI also runs it; and it hides which tool is pinned to which authority.
